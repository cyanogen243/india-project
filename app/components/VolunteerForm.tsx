...
export function VolunteerForm({ language }: { language: Language }) {
  ...
  return (
    ...
    >
      ...
      <p className="privacy-note">{hindi ? "फोन नंबर, पहचान पत्र, फ़ाइल या सटीक स्थान न भेजें। अस्वीकृत या संग्रहीत रिकॉर्ड 180 दिनों के बाद हटाने योग्य हो जाते हैं।" : "Do not send phone numbers, identity documents, files, or precise locations. Declined or archived records become eligible for deletion after 180 days."}</p>
